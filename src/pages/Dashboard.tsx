...
import { SupplierOrdersPanel } from "@/components/dashboard/SupplierOrdersPanel";
  ...
  return (
    <Layout>
      <div className="container py-8 space-y-6">
        ...
        {/* Buyer stats — only show for non-suppliers (or always show alongside supplier) */}
        {!isSupplier && (
        ...
        {/* Supplier tabbed view */}
        {isSupplier ? (
          <Tabs defaultValue="orders" className="space-y-4">
            <TabsList>
              <TabsTrigger value="orders">Orders & Earnings</TabsTrigger>
